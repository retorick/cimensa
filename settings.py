...
DATABASES = {
    'default': {
        ...
        'NAME': 'cimensa',                      # Or path to database file if using sqlite3.
        'USER': 'cimensa',                      # Not used with sqlite3.
        'PASSWORD': '153846',                  # Not used with sqlite3.
...
SECRET_KEY = '$qo$*i+#ov&x!l_z#7+=etzu2v#!tuwfwtbqn6x(-y+lf2yy2x'
